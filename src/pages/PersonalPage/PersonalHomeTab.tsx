...
const PersonalHomeEmpty: React.FC = () => {
      ...
      <IonContent fullscreen className="personal-home">
        <div className="personal-home__scroll">
          ...
          <section className="personal-home__how" aria-labelledby="how-title">
            <h2 id="how-title" className="personal-home__how-title">
              Как это работает
            </h2>
...
/**
 * Главная вкладка: без детей — приглашение добавить; с детьми — список и история.
 */
const PersonalHomeTab: React.FC = () => {
  const childrens = useStore((s) => s.childrens);

  if (childrens.length === 0) {
    return <PersonalHomeEmpty />;
  }
